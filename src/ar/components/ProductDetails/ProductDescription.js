...
const ProductDescription = ({
  ...
  return (
    <div className="product-content" dir="rtl">
      ...
      <h2 className="product-content__title space-mb--20" style={{textAlign: 'right'}}>{product.name}</h2>
      ...
      <div className="product-content__description space-mb--30" style={{textAlign: 'right'}}>
      ...
      <Fragment>
        ...
        <div className="product-content__other-info space-mt--50" dir="rtl" style={{textAlign: 'right'}}>
          <table>
            <tbody>
              ...
              <tr className="single-info">
                <td className="title">كتالوجات: </td>
                <td className="value">
                  {product.category &&
